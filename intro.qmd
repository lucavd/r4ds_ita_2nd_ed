...
Imparerai il resto strada facendo![^intro-1]
[^intro-1]: Se vuoi una panoramica completa di tutte le funzionalità di RStudio, consulta la guida utente all'indirizzo <https://docs.posit.co/ide/user>.
...
Non potrai usare funzioni, oggetti o file di aiuto di un pacchetto finché non lo carichi con `library()`.
